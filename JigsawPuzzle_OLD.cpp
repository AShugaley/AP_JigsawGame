...
JigsawPuzzle_OLD::JigsawPuzzle_OLD(vector<PuzzlePiece> pieces){
...
vector<vector<int>>& JigsawPuzzle_OLD::getSolutionMatrix(){
    return this->solutionMatrix;
}

int JigsawPuzzle_OLD::getSolutionMatrixNumRows(){
    return this->lastRowIndex + 1;
}
int JigsawPuzzle_OLD::getSolutionMatrixNumCols() {
    return this->lastColIndex + 1;
}


void JigsawPuzzle_OLD::initSolMatrix(){
...
PuzzleRequirement JigsawPuzzle_OLD::getReq(int i, int j){
    int l, r, t,b;
...
vector<pair<int,int> > JigsawPuzzle_OLD::getPossibleDimensions() {
...
pair<int,int> JigsawPuzzle_OLD::getNextPos(int i, int j){
    if(j!=lastColIndex){
...
bool JigsawPuzzle_OLD::solveRec(pair<int,int> nextPos){
    int i = nextPos.first;
...
bool JigsawPuzzle_OLD::solveGame(){
...
bool JigsawPuzzle_OLD::printSolutionToFile(string& outputFile){
