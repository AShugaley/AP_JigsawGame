...
public:
    ...
    virtual void updatePuzzlePieceInSolution(PuzzlePiece& p) = 0;
    virtual void revertPuzzlePieceFromSolution(PuzzlePiece& p) = 0;
    virtual void printSolutionToFile(std::string& outputFilePath) = 0;
